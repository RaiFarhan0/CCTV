...
out = cv2.VideoWriter('dummy_fixed.mp4', fourcc, fps, (width, height))

# Simulate something moving to trigger tracker
for i in range(fps * duration):
    # Fix: create 3-channel BGR frame instead of grayscale or forcing it
...
files = {'video': open('dummy_fixed.mp4', 'rb')}
